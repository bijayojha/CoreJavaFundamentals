...
/* Big O notation is a way to measure how well a computer algorithm scales as the amount of data involved increases. It is not always a 
measure of speed as you'll see below   This is a rough overview of Big O and doesn't  cover topics such as asymptotic analysis, which
covers comparing algorithms as data approaches infinity What we are defining is the part of the algorithm that has the greatest effect. For example
...
*/
	...
	public void addItemToArray(int newItem) {
		...
		endTime = System.currentTimeMillis();
		System.out.println(" The arry took time for " + (endTime - startTime));
	...
	// Constructor to initialize the array size and create the array.
